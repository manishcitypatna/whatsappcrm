// seedDefaultPipeline (in PipelinesPage)

// File: src/app/(dashboard)/pipelines/page.tsx
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <GatedButton
            ...
            className="border-slate-700 bg-slate-900 text-slate-200 hover:bg-slate-800 transition-colors"
          >
...
export async function getCurrentAccount(): Promise<AccountContext> {
  ...
  return {
    ...
    account: { id: data.account.id, name: data.account.name },
  };
}

...
- [GitHub Security Advisories](https://github.com/manishcitypatna/whatsappcrm/security/advisories/new)
...
In scope:
- Anything in this repository (`manishcitypatna/whatsappcrm`), including webhook and auth

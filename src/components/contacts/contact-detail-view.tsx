          ...
          <div className="flex flex-col h-full">
            ...
            <SheetHeader className="p-4  ">
              <div className="flex items-center gap-3">
                <Avatar className="size-12 bg-surface-sunken  ">
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-surface-sunken/50   mx-4 mt-3">
                <TabsTrigger
                  value="details"
                  className="data-active:bg-surface-sunken data-active:text-primary text-muted-foreground"
                >
                  Details
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="notes" className="flex-1 flex flex-col min-h-0 px-4 py-3">
                <div className="space-y-2 mb-3">
                  <Textarea
                    ...
                    className="text-foreground placeholder:text-muted-foreground min-h-[60px] text-sm resize-none"
                  />
                  <Button
                    onClick={addNote}
                ...
                <div className="flex-1 overflow-y-auto space-y-2">
                  {loadingNotes ? (
                    ...
                    notes.map((note) => (
                      <div
                        key={note.id}
                        className="rounded-lg bg-surface-sunken/50   p-3 group"
                      >
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="text-foreground h-8 text-sm placeholder:text-muted-foreground"
                        />
                      </div>
                    ))}
                    <Button
                ...
                {loadingDeals ? (
                  ...
                  <div className="space-y-2">
                    {deals.map((deal) => (
                      <div
                        key={deal.id}
                        className="rounded-lg   bg-surface-sunken/50 p-3"
                      >
                        <div className="flex items-start justify-between gap-2">

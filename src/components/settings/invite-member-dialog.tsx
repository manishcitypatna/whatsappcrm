...
export function InviteMemberDialog({
  ...
  return (
    ...
    >
      <DialogContent className="bg-card backdrop-blur-[var(--blur-glass)]  sm:max-w-md">
        {result ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                <span className="font-medium text-foreground">{result.role}</span>
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md  border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
              ...
              <a
                ...
                className={buttonVariants({
                  variant: 'outline',
                  className:
                    'w-full  text-foreground hover:bg-surface-sunken',
                })}
              >
          ...
          <>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="space-y-2">
                <Label className="text-foreground">Link valid for</Label>
                <Select
                  value={expiry}

...
export function WhatsAppConfig() {
  ...
  // Track the account we last fetched for to prevent auth refreshes
  // (e.g. on window focus) from clobbering unsaved form edits.
  ...
  useEffect(() => {
    ...
    // Only perform the initial/automatic fetch if the accountId has
    // actually changed (e.g. switching accounts). Background auth
    // refreshes (which happen on window focus) shouldn't clobber
    // active user edits.
    if (hasFetchedRef.current !== accountId) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_380px] mt-4">
      ...
      <div className="space-y-6">
        ...
        {/* Connection Status */}
        <Alert className="bg-card backdrop-blur-[var(--blur-glass)] ">
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              ...
              <Button
                ...
                className=" bg-transparent text-foreground hover:bg-surface-sunken h-7"
              >
            ...
            {registrationProbe && (
              <div className="mt-3 rounded   bg-card/60 px-3 py-2 space-y-1.5 text-[11px]">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="text-foreground placeholder:text-muted-foreground tracking-widest"
              />
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="shrink-0  text-foreground hover:text-foreground hover:bg-surface-sunken"
                >
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            ...
            className=" text-foreground hover:text-foreground hover:bg-surface-sunken"
          >
            {testing ? (
              <>
                <Loader2 className="size-4 animate-spin" />

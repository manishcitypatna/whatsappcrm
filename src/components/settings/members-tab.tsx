...
> = {
  ...
  agent: {
    icon: UserCog,
    label: 'Agent',
    className: ' bg-surface-sunken text-foreground',
  },
  viewer: {
    icon: UserIcon,
    label: 'Viewer',
    className: ' bg-card backdrop-blur-[var(--blur-glass)] text-muted-foreground',
  },
};
                ...
                >
                  <div className="flex min-w-0 flex-1 items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {isSelf && (
                          <Badge className="bg-surface-sunken text-foreground  text-[10px] uppercase tracking-wide">
                            You
                          </Badge>
                        )}
                      </div>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    {canManageMembers && !isOwnerRow && !isSelf ? (
                      ...
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-md  px-2.5 py-1 text-xs font-medium ${roleMeta.className}`}
                      >
      ...
      <RequireRole min="admin">
        <div>
          <div className="mb-2 flex items-center gap-2">
            ...
            <Badge className="bg-surface-sunken text-muted-foreground ">
              {invitations.length}
            </Badge>
          </div>
            ...
            <Card className="bg-card backdrop-blur-[var(--blur-glass)]  ring-0 ring-transparent">
              <CardContent className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Click <span className="text-foreground">Invite member</span>{' '}
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`inline-flex items-center gap-1 rounded-md  px-2 py-0.5 text-[11px] font-medium ${inviteRoleMeta.className}`}
                          >

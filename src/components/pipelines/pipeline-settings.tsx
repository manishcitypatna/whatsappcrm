...
export function PipelineSettings({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-card backdrop-blur-[var(--blur-glass)]  max-h-[85vh] overflow-y-auto">
        <DialogHeader>
        ...
        {showDeleteConfirm ? (
          <div className="py-4">
            <div className="flex items-center gap-3 rounded-lg  border-red-500/30 bg-red-500/10 p-4">
          ...
          <>
            <div className="grid gap-4 py-2">
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="shrink-0  bg-transparent text-foreground hover:bg-surface-sunken"
                  >
              ...
              <Button
                ...
                className="w-full  bg-transparent text-foreground hover:bg-surface-sunken"
              >
                <Plus className="mr-1 h-3 w-3" />
            ...
            <DialogFooter className=" bg-card/50">
              <Button
                variant="destructive"
...
function SortableStageRow({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex items-center gap-2 rounded-lg   bg-surface-sunken p-2"
    >
      <button
        type="button"
        {...attributes}
      ...
      <Input
        ...
        className="h-7 flex-1 bg-transparent shadow-none text-sm text-foreground focus:border-primary"
      />
      <Button
        variant="ghost"
        size="icon-xs"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-6 z-20 flex flex-wrap gap-1 rounded-lg bg-card backdrop-blur-[var(--blur-glass)] p-2 shadow-floating w-36">
            {colors.map((c) => (
              <button
                key={c}
                type="button"

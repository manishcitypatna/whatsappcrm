...
function StageColumn({
  ...
  return (
    ...
    <div className="flex w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col rounded-xl bg-card/60 p-4 backdrop-blur-[var(--blur-glass)] lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none">
      {/* 3px colored top  — sits above the column's padding */}
      <div
      ...
      <div className="flex items-center justify-between pt-3">
        ...
        <span className="shrink-0 rounded-full bg-surface-sunken px-2 py-0.5 text-[11px] font-medium text-foreground">
          {deals.length}
        </span>
      </div>
      ...
      >
        {deals.length === 0 ? (
          <div className="flex flex-1 items-center justify-center rounded-lg bg-surface-sunken/40 shadow-inset-sm py-10 text-xs text-muted-foreground">
            Drop a deal here
          </div>
        ) : (
          deals.map((deal) => (
      ...
      <Button
        ...
        className="mt-3 w-full justify-start bg-transparent text-muted-foreground hover:bg-surface-sunken hover:text-foreground"
      >

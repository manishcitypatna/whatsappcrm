...
export function DealForm({
  ...
  }, [open, contactId, supabase, accountId]);
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className="bg-card backdrop-blur-[var(--blur-glass)]  text-foreground sm:max-w-lg w-full p-0"
      >
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                className="h-9 w-full rounded-none border-b-2 border-border bg-transparent px-2.5 text-sm text-foreground shadow-none focus:outline-none focus:border-primary"
              >
          ...
          <div className="  bg-card/80 p-4">
            <div className="flex gap-2">
              <Button
                ...
                className="flex-1  bg-transparent text-foreground hover:bg-surface-sunken"
              >
                Cancel
              </Button>
              <Button
            ...
            {deal &&
              (confirmDelete ? (
                <div className="mt-3 flex items-center justify-between gap-2 rounded-md  border-red-500/30 bg-red-500/10 px-3 py-2 text-xs">
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      disabled={deleting}
                      className="rounded px-2 py-1 text-foreground hover:bg-surface-sunken"
                    >
                      Cancel
                    </button>
                    <button

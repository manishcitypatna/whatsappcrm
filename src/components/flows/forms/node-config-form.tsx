        ...
        <div className="flex flex-col gap-3">
          {buttons.map((b, i) => (
            <div
              key={i}
              className={cn(
                "grid grid-cols-1 gap-2 rounded-md   bg-surface-sunken/40 p-3",
                showAdvanced
    ...
    <>
      ...
      <div className="mt-2">
        ...
        {sections.map((section, sIdx) => (
          <div
            key={sIdx}
            className="mb-3 rounded-md   bg-surface-sunken/40 p-3"
          >
      ...
      <div>
        ...
        {cfg.media_url ? (
          ...
          <button
            ...
            disabled={uploading}
            className="flex w-full items-center justify-center gap-2 rounded-md bg-card shadow-inset-sm backdrop-blur-[var(--blur-glass)] px-3 py-4 text-xs text-muted-foreground transition-all hover:bg-surface-sunken hover:text-foreground disabled:cursor-not-allowed disabled:opacity-60"
          >
            {uploading ? (
              <>

  ...
  return (
    <FlowEditorProvider initialFlow={initialFlow} initialNodes={initialNodes}>
      <div className="mx-auto flex h-full max-w-4xl flex-col gap-6 p-6">
        ...
        {!isMobile && (
          <div className="flex items-center justify-end">
            <div
              ...
              className="inline-flex items-center gap-1 rounded-md   bg-card backdrop-blur-[var(--blur-glass)] p-0.5 text-xs"
            >
              <ToggleButton
        ...
        <div className="sticky bottom-4 z-10 shadow-xl shadow-black/60">
          <ValidationPanel />
        </div>
      </div>
    </FlowEditorProvider>

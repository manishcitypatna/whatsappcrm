        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          {onBack && (
            <button
              ...
              className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md text-foreground hover:bg-surface-sunken hover:text-foreground lg:hidden"
            >
              <ArrowLeft className="h-5 w-5" />
            </button>
          )}
          <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-surface-sunken text-sm font-medium text-foreground">
        ...
        <div className="flex items-center gap-2">
          ...
          {onRefresh && (
            <button
              ...
              title="Refresh"
              className={cn(
                "inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-surface-sunken hover:text-foreground disabled:opacity-60",
              )}
            >
              <RefreshCw
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className={cn(
                  "inline-flex items-center justify-center h-7 gap-1 px-2 text-xs rounded-md hover:bg-surface-sunken",
            ...
            {messageGroups.map((group) => (
              <div key={group.date}>
                ...
                <div className="mb-4 flex items-center justify-center">
                  <span className="rounded-full bg-surface-sunken px-3 py-1 text-[10px] font-medium text-muted-foreground">

  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute -top-3 z-10 flex h-7 items-center gap-0.5 rounded-full   bg-card/95 px-1 shadow-md backdrop-blur-sm transition-opacity",
      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger
            className="flex h-5 w-5 items-center justify-center rounded-full text-foreground hover:bg-surface-sunken hover:text-foreground"
            aria-label="React"
          >
          ...
          >
            {QUICK_EMOJIS.map((e) => (
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full text-lg leading-none transition-transform hover:scale-125 hover:bg-surface-sunken"

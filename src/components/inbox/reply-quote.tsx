  ...
  return (
    <div
      className={cn(
        ...
        isChip
          ? "rounded-md bg-primary/10 shadow-inset-sm"
          : "mb-1.5 rounded-md bg-primary/10",
      )}
    >
      ...
      {onDismiss && (
        <button
          ...
          className="flex h-6 w-6 shrink-0 items-center justify-center rounded text-muted-foreground hover:bg-surface-sunken hover:text-foreground"
        >

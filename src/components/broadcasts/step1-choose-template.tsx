...
export function Step1ChooseTemplate({ selectedTemplate, onSelect, onNext, onBack }: Step1Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {templates.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl   bg-card/50">
              ...
              <button
                ...
                className={`flex flex-col gap-3 rounded-xl  p-4 text-left transition-all ${
                  isSelected
                    ...
                    : ' bg-card/50 hover: hover:bg-card backdrop-blur-[var(--blur-glass)]'
                }`}
              >
      ...
      <div className="flex items-center justify-between   pt-4">
        <Button variant="outline" onClick={onBack} className=" text-foreground">
          Back
        </Button>
        <Button
          onClick={onNext}

...
export function Step2SelectAudience({
  ...
  return (
    <div className="space-y-6">
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center rounded-full  px-3 py-1 text-xs font-medium transition-all ${
                      isSelected
                        ? ' bg-primary/10 text-primary'
                        : ' bg-surface-sunken text-foreground hover:'
                    }`}
                  >
                    <span
      ...
      {audience.type === 'custom_field' && (
        <div className="space-y-3 rounded-xl   bg-card/50 p-4">
          ...
          {loadingFields ? (
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_140px_minmax(0,1fr)]">
              <select
                ...
                className="h-9 rounded-lg   bg-surface-sunken px-2.5 text-sm text-foreground outline-none  focus:ring-1 focus:ring-primary"
              >
              ...
              <input
                ...
                placeholder="Value"
                className="h-9 rounded-lg   bg-surface-sunken px-2.5 text-sm text-foreground outline-none placeholder:text-muted-foreground  focus:ring-1 focus:ring-primary"
              />
            </div>
          )}
        </div>

  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              className=" text-muted-foreground hover:bg-surface-sunken hover:text-foreground disabled:opacity-30"
            >
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="bg-card backdrop-blur-[var(--blur-glass)]  text-foreground sm:max-w-sm">
          <DialogHeader>

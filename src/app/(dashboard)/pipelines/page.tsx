...
export default function PipelinesPage() {
  ...
  const handleDealMoved = useCallback(
    ...
    [supabase, refreshDeals, accountId],
  );
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="h-9 w-28 animate-pulse rounded-lg bg-surface-sunken" />
        </div>
        <div className="flex gap-3">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-96 w-72 animate-pulse rounded-xl bg-surface-sunken/50" />
          ))}
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              className="inline-flex items-center gap-2 rounded-lg   bg-card backdrop-blur-[var(--blur-glass)] px-3 py-2 text-sm text-foreground hover:bg-surface-sunken transition-colors data-[popup-open]:bg-surface-sunken"
            >
            ...
            <DropdownMenuContent
              align="start"
              className="w-64  bg-card backdrop-blur-[var(--blur-glass)] text-foreground"
            >
              {pipelines.length === 0 && (
      ...
      <Dialog open={newPipelineOpen} onOpenChange={setNewPipelineOpen}>
        <DialogContent className="sm:max-w-sm bg-card backdrop-blur-[var(--blur-glass)] ">
          <DialogHeader>

            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl   bg-card backdrop-blur-[var(--blur-glass)] p-4 text-left transition-colors  hover:bg-card/80"
                >
...
function AutomationCard({
  ...
  return (
    <li className="rounded-xl bg-card shadow-raised backdrop-blur-[var(--blur-glass)] transition-all hover:shadow-raised-lg">
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-surface-sunken hover:text-foreground data-[popup-open]:bg-surface-sunken"
            >

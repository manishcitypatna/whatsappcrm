...
function StatCard({ label, value, total, icon, color }: StatCardProps) {
  ...
  return (
    <div className="rounded-xl   bg-card backdrop-blur-[var(--blur-glass)] p-4">
        ...
        {steps.map((step) => {
          ...
          return (
            <div key={step.label} className="flex items-center gap-3">
              ...
              <div className="relative h-7 flex-1 rounded-full bg-surface-sunken">
                <div
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        {/* Delete — inline-confirm pattern matches the pipeline-settings
            ...
            funnel inconsistent. */}
        {confirmDelete ? (
          <div className="flex items-center gap-2 rounded-md  border-red-500/30 bg-red-500/10 px-3 py-1.5 text-sm">
            ...
            <Button
              ...
              disabled={deleting}
              className="h-7  bg-transparent text-foreground hover:bg-surface-sunken"
            >
              Cancel
            </Button>
            <Button
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <StatCard
          ...
          color="bg-surface-sunken text-foreground"
        />
        <StatCard
          label="Sent"
      ...
      {/* Recipients Table */}
      <div className="rounded-xl   bg-card backdrop-blur-[var(--blur-glass)]">
        <div className="flex flex-wrap items-center justify-between gap-2   px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent className=" bg-card backdrop-blur-[var(--blur-glass)]">
                <DropdownMenuItem
            ...
            <Table>
              ...
              <TableBody>
                {filteredRecipients.map((recipient) => {
                  ...
                  return (
                    <TableRow key={recipient.id} className="">
                      ...
                      <TableCell>
                        <span
                          className={`inline-flex items-center rounded-full  px-2 py-0.5 text-xs font-medium ${rStatus.classes}`}
                        >
                          {rStatus.label}
                        </span>
                      </TableCell>

    ...
    <div className="space-y-6">
      ...
      {anySending && (
        <div
          ...
          className="broadcast-indeterminate fixed inset-x-0 top-0 z-40 h-0.5 overflow-hidden bg-surface-sunken"
        >
      ...
      {broadcasts.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-xl   bg-card backdrop-blur-[var(--blur-glass)]">
        ...
        <div className="overflow-x-auto rounded-xl   bg-card backdrop-blur-[var(--blur-glass)]">
          <Table>
            <TableHeader>
              ...
              {broadcasts.map((broadcast) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-full  px-2 py-0.5 text-xs font-medium ${status.classes}`}
                      >
                        {status.pulse && (

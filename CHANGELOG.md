...
- **`send_media` flow node.** Send an image (PNG / JPEG / WebP), video
  ...
  ([#156](https://github.com/manishcitypatna/whatsappcrm/pull/156))
...
- **Inbound WhatsApp messages no longer silently disappear** when two
  ...
  layer. Reported in
  [#136](https://github.com/manishcitypatna/whatsappcrm/issues/136), fixed in
  [#143](https://github.com/manishcitypatna/whatsappcrm/pull/143).
...
- **Module + schema.** New `flows`, `flow_nodes`, `flow_runs`,
  ...
  ([#112](https://github.com/manishcitypatna/whatsappcrm/pull/112))
- **Runner engine.** `dispatchInboundToFlows` parses every inbound
  ...
  ([#114](https://github.com/manishcitypatna/whatsappcrm/pull/114))
- **No-code builder UI** at `/flows`. Linear-list editor with
  ...
  ([#115](https://github.com/manishcitypatna/whatsappcrm/pull/115))
- **Templates + v1.5 node types.** Three starter templates
  ...
  ([#117](https://github.com/manishcitypatna/whatsappcrm/pull/117))
...
- **5 color themes** (Violet default, Emerald, Cobalt, Amber, Rose)
  ...
  ([#132](https://github.com/manishcitypatna/whatsappcrm/pull/132))
- **Theme tokenization sweep** — every previously hard-coded
  ...
  not just the chrome.
  ([#133](https://github.com/manishcitypatna/whatsappcrm/pull/133))
...
- **Atomic `execution_count` increment** via SECURITY DEFINER RPC —
  ...
  ([#124](https://github.com/manishcitypatna/whatsappcrm/pull/124))
- **Preload all flow_nodes once per dispatch** — one SELECT per
  ...
  ([#125](https://github.com/manishcitypatna/whatsappcrm/pull/125))
- **Wasted re-read dropped** after reprompt reset; `loadActiveRun`
  ...
  ([#126](https://github.com/manishcitypatna/whatsappcrm/pull/126))
...
- **PII redacted from `reply_received` event payload** — customer
  ...
  ([#123](https://github.com/manishcitypatna/whatsappcrm/pull/123))
- **Constant-time cron-secret compare** on `/api/flows/cron`
  ...
  ([#127](https://github.com/manishcitypatna/whatsappcrm/pull/127))
...
- **`/flows` no longer spuriously redirects to `/dashboard`** when
  ...
  ([#128](https://github.com/manishcitypatna/whatsappcrm/pull/128))
